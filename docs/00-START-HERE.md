...
**Written:** 2026-08-24 · **Updated:** 2026-08-26 (channels directory **built** — «کانال‌ها و گروه‌ها», `1c18c35`; header rebuilt) · **Docs version:** 3.15
...
| `15-channels-directory.md` | **Built 26 Aug, migration not run.** Telegram/WhatsApp channels directory — the `metrics_source` axis, the no-content rule, and what phase 1 owes the phase-2 bot |
