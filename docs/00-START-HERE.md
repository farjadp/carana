...
| Plans v2 | Pro → **استارتر (Starter)**, Featured → **پریمیوم (Premium)** (display names only — `PlanId` stays `pro`/`featured`, see `lib/billing/plans.ts`). Four tiered features shipped: **gallery**, **review replies**, **busy now/quiet now**, **announcements** (free 1/Starter 3/Premium unlimited per rolling 30 days, new dashboard sub-page + profile banner). Vanity URLs and 7 more Premium items remain, tracked in Notion Mission Control |
