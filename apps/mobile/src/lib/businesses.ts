 ...
 */
const CARD_COLUMNS =
  "id, ref_no, slug, name, name_en, category, sub_category, tagline, short_description, city, province, phone, website, logo_url, cover_url, busy_status, busy_status_until";
