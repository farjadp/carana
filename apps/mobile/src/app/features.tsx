...
const OWNER_PREMIUM: Row[] = [
  ...
  { title: "بخش ویژه‌ی صفحه‌ی اول", body: "در بالای صفحه‌ی نخست پلازا." },
];
...
const COMING = [
  "رزرو نوبت واقعی داخل پلازا (الان فقط لینک بیرونی است)",
  ...
  "دریافت رزومه داخل پلازا (درخواست‌ها مستقیم به خود کسب‌وکار می‌رود)",
];
