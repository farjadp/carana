  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      >
        ...
        {/* ── Announcements — absent when nobody has posted one, same rule
               as every other conditional rail on this screen ───────────── */}
        {announcements.length > 0 ? (
          <>
            <SectionHeader title="تازه‌ترین اعلان‌ها" icon={<Megaphone size={15} color={colors.gold} />} />
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.rail} style={styles.shelfScroll}>
              {announcements.map((a) => (
