...
const VISITOR_FREE: Item[] = [
  ...
  },
  {
    ...
    body: "آگهی استخدام کسب‌وکارهای ایرانی، با فیلتر شهر، نوع همکاری و اینکه کدام زبان لازم است. هر آگهی تاریخ انقضا دارد و بعد از آن خودبه‌خود برداشته می‌شود، پس چیزی که می‌بینی هنوز باز است. درخواست مستقیم به خود کسب‌وکار می‌رود؛ گوپلازا رزومه‌ای دریافت نمی‌کند.",
  },
  {
    icon: <Mic size={18} />,
...
const OWNER_PREMIUM: Item[] = [
  ...
  },
  {
    ...
    body: "در بالای صفحه‌ی نخست گوپلازا.",
  },
  {
...
const COMING = [
  "رزرو نوبت واقعی داخل گوپلازا (الان فقط لینک به تقویم بیرونی است)",
  ...
  "دریافت رزومه داخل گوپلازا (درخواست‌ها مستقیم به ایمیل، تلفن یا فرم خود کسب‌وکار می‌رود)",
];
        ...
        <section className="border-t border-[color:var(--line)] bg-[color:var(--bg)] px-4 py-14">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-2 text-sm leading-7 text-[color:var(--muted-text)]">
              این‌ها ساخته نشده‌اند. اگر جایی در گوپلازا خلافش را دیدی، آن یک اشتباه است و
              می‌خواهیم بدانیم.
            </p>
