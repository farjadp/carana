...
export const metadata: Metadata = {
  alternates: { canonical: "/team" }, title: "معرفی تیم", description: "چه کسانی پلازا را می‌سازند." };

export default function TeamPage() {
  return (
    <InnerPage currentPath="/team" currentSection="brand" eyebrow="تیم" title="یک نفر، یک شرکت، یک جامعه." description="پلازا را آشاوید می‌سازد — و جامعه‌ای که هر روز با ثبت، احراز و نظر دادن کاملش می‌کند.">
      <section className="grid lg:grid-cols-12 gap-6" dir="rtl">
        <div className="lg:col-span-7 rounded-3xl bg-white border border-[color:var(--line)] p-6 md:p-7">
          ...
          <div className="mt-5 flex flex-wrap gap-2 text-xs">
            ...
            <Link href="/businesses/farjad-pourmohammad" className="inline-flex items-center gap-1.5 bg-[color:var(--annabi)]/8 hover:bg-[color:var(--annabi)]/12 px-3 py-1.5 rounded-full font-bold text-[color:var(--annabi)] transition">پروفایل در پلازا <ArrowLeft size={12} /></Link>
          </div>
        </div>
        ...
        <aside className="lg:col-span-5 space-y-4">
          <div className="rounded-3xl bg-[color:var(--text)] text-[#f6f1e8] p-6 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-sm text-[#f6f1e8]/80 leading-relaxed mt-3">شرکت اجرایی و تحول دیجیتال در تورنتو: سیستم‌های عملیاتی، اتوماسیون هوش مصنوعی و مسیرهای بنیان‌گذاری برای مهاجران. پلازا محصولِ خودِ آشاوید است — نه پروژه‌ی مشتری.</p>
              <div className="mt-4 flex flex-wrap gap-2 text-xs">
                ...
                <Link href="/businesses/ashavid" className="bg-white/10 hover:bg-white/20 px-3 py-1.5 rounded-full transition">پروفایل در پلازا</Link>
              </div>
            </div>
          </div>
