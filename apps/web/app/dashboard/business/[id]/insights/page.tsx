    ...
    <PageShell currentPath={`/dashboard/business/${id}/insights`} currentSection="business">
      <main className="mx-auto max-w-5xl px-4 py-10">
        ...
        <p className="mt-6 text-xs leading-6 text-[color:var(--muted-text)]">
          گوپلازا هویت بازدیدکننده را ذخیره نمی‌کند. برای اینکه یک نفر در یک روز چند بار شمرده نشود، از یک اثر رمزنگاری‌شده استفاده می‌شود که هر روز عوض می‌شود و به هیچ شخصی برنمی‌گردد.
        </p>
      </main>
    </PageShell>
  );
