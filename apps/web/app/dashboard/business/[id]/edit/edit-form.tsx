...
const STATUS_LABELS: Record<string, { label: string; color: string; hint: string }> = {
  ...
  SUBMITTED:     { label: "در انتظار تایید",    color: "bg-blue-100 text-blue-700",           hint: "در صف بررسی توسط تیم پلازا." },
  NEEDS_CHANGES: { label: "نیازمند اصلاح",      color: "bg-amber-100 text-amber-700",         hint: "تیم پلازا اصلاحاتی خواسته است. لطفاً ویرایش کنید." },
      ...
      <div className="max-w-2xl mx-auto">
        <div className="p-8 bg-white border border-[color:var(--line)] rounded-2xl shadow-sm text-center">
          ...
          <p className="text-[color:var(--muted-text)] leading-loose text-sm mb-8">
            اطلاعات بروز شده کسب‌وکار شما مجدداً به تیم کارشناسان پلازا ارسال شد.
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl p-5 mb-8 shadow-sm">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-blue-700/80 mb-4">آدرس وب‌سایت خود را وارد کنید تا هوش مصنوعی پلازا اطلاعات اولیه را خوانده و فرم را برای شما پر کند.</p>
        ...
        <FormProvider {...methods}>
          <form>
            <div className="p-6 md:p-8 space-y-5">
              ...
              {/* ── مرحله ۴: اعتبار ── */}
              {currentStep === 4 && (
                <StepWrapper title="۴. جزئیات اعتماد و اعتبار" description="اطلاعات محرمانه که فقط برای تیم پلازا قابل مشاهده است.">
              ...
              {/* ── مرحله ۷: ارسال مجدد ── */}
              {currentStep === 7 && (
                <StepWrapper title="۷. ارسال مجدد برای بررسی" description="اطلاعات ویرایش‌شده را برای بررسی مجدد توسط تیم پلازا ارسال کنید.">
                  {/* خلاصه تغییرات */}
