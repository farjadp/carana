...
import { PlusCircle, Building2, Calendar, Clock } from "lucide-react";
        ...
        {(!businesses || businesses.length === 0) ? (
          <div className="flex flex-col items-center justify-center p-12 bg-gray-50 rounded-3xl border border-dashed border-[color:var(--line)] text-center">
            ...
            <p className="text-[color:var(--muted-text)] max-w-md mb-6">
              شما می‌توانید پروفایل کسب‌وکار خود را در دایرکتوری ایجاد کنید تا پس از بررسی تیم چارانا، به هزاران ایرانی در کانادا معرفی شوید.
            </p>
            <Link 
              href="/dashboard/business/new"
