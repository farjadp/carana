      ...
      <div className="max-w-2xl mx-auto">
        <div className="p-8 bg-white border border-[color:var(--line)] rounded-2xl shadow-sm text-center">
          ...
          <p className="text-[color:var(--muted-text)] mb-6 leading-loose text-sm">
            ...
            تیم كارشناسان čārana اطلاعات را بررسی کرده و پس از تایید، کسب‌وکار شما در دایرکتوری عمومی
            ...
            <div className="p-6 md:p-8">
              ...
              {currentStep === 4 && (
                <StepWrapper
                  ...
                  description="این اطلاعات صرفاً برای راستی‌آزمایی توسط تیم čārana دریافت می‌شود و در پروفایل عمومی نمایش داده نخواهد شد."
                >
                  {/* هشدار محرمانه بودن */}
              ...
              {currentStep === 7 && (
                ...
                >
                  ...
                  <div className="space-y-3 mt-6 p-5 bg-blue-50/70 rounded-xl border border-blue-100">
                    ...
                    <TermsCheckbox id="terms2" label="می‌پذیرم که انتشار نهایی در دایرکتوری، پس از بررسی و تایید تیم čārana انجام خواهد شد." />
                    <TermsCheckbox id="terms3" label={<>با <a href="/terms" target="_blank" className="underline text-[color:var(--lajvard)]">شرایط استفاده</a> و <a href="/privacy" target="_blank" className="underline text-[color:var(--lajvard)]">حریم خصوصی</a> čārana موافقم.</>} />
                  </div>
                </StepWrapper>
              )}
            </div>
