...
export const metadata: Metadata = {
  ...
  title: "سلب مسئولیت",
  description:
    "حدود مسئولیت گوپلازا درباره‌ی صحت اطلاعات کسب‌وکارها، معنای نشان تایید، نظرات کاربران، آگهی‌های شغلی، فهرست کانال‌ها، نرخ ارز و محتوای تولیدشده با هوش مصنوعی.",
};
