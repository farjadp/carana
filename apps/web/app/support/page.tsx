...
const GROUPS: { title: string; items: Faq[] }[] = [
  ...
  },
  {
    title: "برای کاربران",
    items: [
      { q: "چارانا رایگان است؟", a: <>بله — هم برای جستجو و استفاده، هم برای ثبت کسب‌وکار. چارانا واسطه‌ی هیچ معامله‌ای نیست و کمیسیونی نمی‌گیرد.</> },
      ...
      { q: "رمز عبورم را فراموش کرده‌ام.", a: <>از <Link href="/auth/forgot-password">صفحه‌ی بازیابی رمز</Link> استفاده کنید. ایمیل از <span dir="ltr">noreply@charana.ca</span> می‌آید — اگر نرسید، پوشه‌ی هرزنامه را ببینید.</> },
