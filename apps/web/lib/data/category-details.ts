...
export const CATEGORY_DETAILS: Record<string, CategoryDetailConfig> = {
  ...
  "events": {
    ...
    faqs: [
      {
        question: "چگونه رویداد خود را در پلازا قرار دهم؟",
    ...
    faqs: [
      {
        ...
        answer: "بخشی از آگهی‌ها را پلازا گردآوری کرده و صاحبانشان هنوز مالکیت را احراز نکرده‌اند. آگهی‌هایی که نشان تایید دارند، صاحبشان تسلطش بر شماره تماس منتشرشده را اثبات کرده است.",
      },
    ]
  };
}
