// ============================================================================
// Source: packages/core/src/fetch-all.ts
...
//
//      v2 (24 Aug): moved out of apps/web into @goplaza/core. The 18 Aug fix
//      only ever reached the website — the mobile home screen was still
//      counting a 1,000-row slice client-side and printing «۱٬۰۰۰ کسب‌وکار»
//      under a directory of 5,251, with the same undercount reaching every
//      category badge, every city count and every province total. The
//      structural typing below was already written for two supabase-js
//      versions; this is the move it was waiting for.
// Env / Identity: Pure pagination over whatever query builder is passed. No
//      client of its own, so RLS still decides what is visible. Safe on
//      native — nothing here is Node- or Next-specific.
// ============================================================================
/**
