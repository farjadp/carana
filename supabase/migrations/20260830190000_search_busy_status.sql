-- ============================================================================
-- Migration: expose busy_status in search results
-- Date: 2026-08-16
--
-- Same mechanical reason as the plan/plan_until addition two migrations
-- back: the app computes "is this status still active" from
-- busy_status_until (lib/business/live-status.ts), so the RPC just needs to
-- pass both columns through — no new ranking logic, ordering is unchanged.
-- ============================================================================
...
returns table (
  ...
  plan text, plan_until timestamptz, busy_status text, busy_status_until timestamptz,
